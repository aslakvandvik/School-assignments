...
if __name__ == '__main__':
   ...
   # Breadth-first search 
    ...
    # Heuristic search - MaxDimH 
    print("\nHeuristic search - MaxDimH")
    sp = GridWalkSpace(PriorityQueue(), MaxDimH())
    sp.solve()

    # Heuristic search - PythagorasH (Euclidean distance)
    print("\nHeuristic search - PythagorasH (Euclidean)")
    sp = GridWalkSpace(PriorityQueue(), PythagorasH())
    sp.solve()

    # Heuristic search - ApproxMaxDimH (3 × MaxDimH)
    print("\nHeuristic search - ApproxMaxDimH (3xMaxDimH)")
