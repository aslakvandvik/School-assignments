package no.uib.oop.calculator.gui;
...
import no.uib.oop.calculator.Calculator;
import no.uib.oop.calculator.expression.Expression;
import no.uib.oop.calculator.expression.ExpressionParser;
...
public class CalculatorGUI {
	...
	public CalculatorGUI(Calculator calculator) {
		...
		this.frame = new JFrame("OOP Calculator");
