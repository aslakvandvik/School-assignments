[forrige](./05-attack.md)  &bullet; [oversikt](../README.md#steg-for-steg) &bullet; [neste](./07-referanser.md)
...
✅ Denne oppgaven er fullført når alle testene i `PokemonBattleTest.java` passerer.
