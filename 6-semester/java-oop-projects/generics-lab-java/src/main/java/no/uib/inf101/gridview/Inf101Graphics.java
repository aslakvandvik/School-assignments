...
// University of Bergen this OOP course helper methods for graphics with Swing.
...
public class this OOP courseGraphics {
	...
	public static void drawCenteredString(Graphics g, String s, Point2D p) {
		this OOP courseGraphics.drawCenteredString(g, s, p.getX(), p.getY());
	}
	...
	public static void drawCenteredString(Graphics g, String s, Shape shape) {
		this OOP courseGraphics.drawCenteredString(g, s, shape.getBounds2D().getCenterX(), shape.getBounds2D().getCenterY());
	}
	...
	public static void drawImage(Graphics g, Image image, double x, double y, double scale) {
		this OOP courseGraphics.drawImage(g, image, x, y, scale, 0);
	}
	...
	public static void drawCenteredImage(Graphics g, Image image, double cx, double cy, double scale) {
		this OOP courseGraphics.drawCenteredImage(g, image, cx, cy, scale, 0);
	}
	...
	public static BufferedImage loadImageFromResources(String filename) {
		...
		InputStream is = this OOP courseGraphics.class.getResourceAsStream(filename);
		if (is == null) {
