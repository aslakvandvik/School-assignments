...
// University of Bergen OOP helper methods for graphics with Swing.
...
public class OopGraphics {
	...
	public static void drawCenteredString(Graphics g, String s, Point2D p) {
		OopGraphics.drawCenteredString(g, s, p.getX(), p.getY());
	}
	...
	public static void drawCenteredString(Graphics g, String s, Shape shape) {
		OopGraphics.drawCenteredString(g, s, shape.getBounds2D().getCenterX(), shape.getBounds2D().getCenterY());
	}
	...
	public static void drawImage(Graphics g, Image image, double x, double y, double scale) {
		OopGraphics.drawImage(g, image, x, y, scale, 0);
	}
	...
	public static void drawCenteredImage(Graphics g, Image image, double cx, double cy, double scale) {
		OopGraphics.drawCenteredImage(g, image, cx, cy, scale, 0);
	}
	...
	public static BufferedImage loadImageFromResources(String filename) {
		...
		InputStream is = OopGraphics.class.getResourceAsStream(filename);
		if (is == null) {
