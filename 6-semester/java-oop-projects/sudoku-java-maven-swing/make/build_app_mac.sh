...
#
# Simplified by Torstein Strømme to fit OOP at the University of Bergen.
...
echo "  APP_PACKAGE: $APP_PACKAGE"         # e.g. "no.uib.oop.colorgrid"
...
echo "  MAIN_CLASS: $MAIN_CLASS"           # e.g. "no.uib.oop.gridview.Main"
