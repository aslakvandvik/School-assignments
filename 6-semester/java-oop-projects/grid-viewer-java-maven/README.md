...
Slike strukturer brukes ofte i grafiske applikasjoner, for eksempel i semesteroppgave 1 i 2025, **Tetris**:  
...
### NB: Denne labben skal rettes med tester og manuelt (se steg 2).
