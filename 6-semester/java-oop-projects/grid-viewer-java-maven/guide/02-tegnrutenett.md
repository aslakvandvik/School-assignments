...
## **8️⃣ Fyll inn gridet** 
Bruk `IGrid::set` til å fylle inn noe fargerikt for oss å se på når vi retter labben :) Her må du minst legge til 4 celler, men du kan gjøre mye mer!
