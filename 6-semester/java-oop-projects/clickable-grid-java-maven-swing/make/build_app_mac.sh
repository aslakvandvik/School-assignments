...
#
# Simplified by Torstein Strømme to fit this OOP course at the University of Bergen.
...
echo "  APP_PACKAGE: $APP_PACKAGE"         # e.g. "no.uib.this OOP course.colorgrid"
...
echo "  MAIN_CLASS: $MAIN_CLASS"           # e.g. "no.uib.this OOP course.gridview.Main"
